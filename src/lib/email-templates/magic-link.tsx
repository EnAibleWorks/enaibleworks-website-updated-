...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your secure sign-in link for EnAibleWorks.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          <Heading style={h1}>Sign in to EnAibleWorks</Heading>
          <Text style={text}>
            Click the button below to securely sign in to your account. For
            your protection, this link will expire shortly and can only be
            used once.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            If you did not request this sign-in link, you may safely ignore
            this email.
          </Text>
        </Section>
