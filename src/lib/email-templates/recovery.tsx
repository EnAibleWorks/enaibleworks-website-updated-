...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your EnAibleWorks password.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            We received a request to reset the password for your EnAibleWorks
            account. Click the button below to choose a new password and
            regain access.
          </Text>
